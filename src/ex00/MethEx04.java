...
public class MethEx04 {
    ...
    public static void main(String[] args) {
        ...
        attackLionToTiger(lion1, tiger2);
        attackLionToBear(lion1, Bear3);
        attackTigerToLion(tiger2, lion1);
        attackTigerToBear(tiger2, Bear3);
        attackBearToLion(Bear3, lion1);
        attackBearToTiger(Bear3, tiger2);
    }
}
